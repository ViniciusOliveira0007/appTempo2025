...
export default function Itanhaem(){
    ...
    async function buscaTempo(){
        const response = await Api.get('weather?array_limit=6&fields=only_results,temp,city_name,forecast,condition,max,min,moon_phase,description,date&key=6c77a5ae&city_name=Santos,SP');
